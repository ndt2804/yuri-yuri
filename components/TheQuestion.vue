<template>
    <section class="py-10 bg-gray-50 sm:py-16 lg:py-24">
            ...
            <div class="max-w-3xl mx-auto mt-8 space-y-4 md:mt-16">
                <div
                    ...
                    <button type="button" class="flex items-center justify-between w-full px-4 py-5 sm:p-6">
                        ...
                        <svg class="w-6 h-6 text-gray-400 rotate-180" xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    <div class="px-4 pb-5 sm:px-6 sm:pb-6">
                        <p>Amet minim mollit non deserunt ullamco est sit <a href="#" title=""
                                class="text-blue-600 transition-all duration-200 hover:underline">aliqua dolor</a> do amet
        ...
        <p class="text-center text-gray-600 textbase mt-9">Didn’t find the answer you are looking for? <a href="#"
                title=""
