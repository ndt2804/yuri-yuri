<template>
    <section class="p-6 sm:p-20 sm:-mt-32 font-poppins">
        <div class="bg-[#DFD7F9] rounded-tl-[10rem] rounded-lg relative">
            <svg class="absolute -top-3 -right-4 z-10" width="70" height="70" viewBox="0 0 70 70" fill="none"
                ...
                <defs>
                    <linearGradient id="paint0_linear_1_489" x1="49.6467" y1="1.96393" x2="19.564" y2="77.7643"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#747DEF" />
                        <stop offset="1" stop-color="#5E3BE1" />
                    </linearGradient>
                    <linearGradient id="paint1_linear_1_489" x1="32.4077" y1="34.5441" x2="33.5452" y2="36.8251"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#747DEF" />
                        <stop offset="1" stop-color="#5E3BE1" />
                    </linearGradient>
                    <linearGradient id="paint2_linear_1_489" x1="32.9029" y1="35.4017" x2="33.507" y2="36.5259"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#747DEF" />
                        <stop offset="1" stop-color="#5E3BE1" />
                    </linearGradient>
            ...
            <div class="space-y-12 px-12 py-28 sm:p-28">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4 z-20">
                    <div class="bg-white px-6 py-3 flex space-x-3 items-center rounded-lg z-40">
                        <svg width="21" height="18" viewBox="0 0 21 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M4 6L9.4 10.05C9.75556 10.3167 10.2444 10.3167 10.6 10.05L16 6" stroke="#39425D"
                                stroke-linecap="round" />
                            <rect x="0.5" y="0.5" width="20" height="17" rx="4.5" stroke="#39425D" />
                        </svg>
                        <input type="text" placeholder="Your email" class="bg-transparent border-0 outline-none w-full" />
                    </div>
            ...
            <svg class="absolute top-0 right-0 z-10" width="264" height="352" viewBox="0 0 264 352" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.1">
                    <mask id="mask0_1_461" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="264"
                        height="352">
                        <path
                            d="M0.5 0.5H240C252.979 0.5 263.5 11.0213 263.5 24V351.022H50C22.6619 351.022 0.5 328.86 0.5 301.522V0.5Z"
                            fill="url(#paint0_linear_1_461)" stroke="#6246E5" />
                    </mask>
                ...
                <defs>
                    <linearGradient id="paint0_linear_1_461" x1="187.239" y1="9.86234" x2="5.23216" y2="354.287"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#747DEF" />
                        <stop offset="1" stop-color="#5E3BE1" />
                    </linearGradient>
            ...
            <svg class="absolute -bottom-16 sm:bottom-0 -left-16 w-80 sm:w-0 sm:-left-20 z-10" width="480" height="361"
                viewBox="0 0 480 361" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g opacity="0.1">
                    <mask id="mask0_1_470" style="mask-type: alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="480"
                        height="361">
                        <rect x="479.5" y="0.5" width="360" height="479" transform="rotate(90 479.5 0.5)"
                            fill="url(#paint0_linear_1_470)" stroke="#6246E5" />
                    </mask>
                ...
                <defs>
                    <linearGradient id="paint0_linear_1_470" x1="736.035" y1="13.4669" x2="487.704" y2="484.066"
                        gradientUnits="userSpaceOnUse">
                        <stop stop-color="#747DEF" />
                        <stop offset="1" stop-color="#5E3BE1" />
                    </linearGradient>
            ...
            <svg class="absolute -bottom-16 -right-3 sm:-right-12 -z-10" width="153" height="166" viewBox="0 0 153 166"
